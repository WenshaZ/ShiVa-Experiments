...
# Flower data
Load the data from phylolm package. We then apply ShiVa, l1ou+pBIC, l1ou+BIC, phyloEM and PCMFit on the flower data.
```{r}
...
# Sunfish data
Load the data from phytools package. We then apply ShiVa, l1ou+pBIC, l1ou+BIC, phyloEM and PCMFit on the flower data.

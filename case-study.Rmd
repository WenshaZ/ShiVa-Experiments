...
############ ShiVa ###############
set.seed(32)
ShiVa_model = ShiVa(Y2, tree2, alpha = NULL, refit_alpha = FALSE,
                    lambda1_list = NULL, lambda2_list = exp(1:10*0.4-6),
                    nfolds = 8, top_k = 6, max.steps = 300,
                    lambda.type = "lambda.min", max.num.shifts = 16,
                    measurement_error = FALSE, verbose = FALSE)$best_model
print(paste0("ShiVa: shifts in opimal value - ",paste(which(ShiVa_model$beta!=0),collapse=",")))
print(paste0("ShiVa: shifts in variance - ",paste(which(ShiVa_model$gamma!=0),collapse=",")))
```
